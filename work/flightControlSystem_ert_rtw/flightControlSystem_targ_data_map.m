    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(5)  = dumData; %prealloc
                    ...
                    ;% ntrh2fpvwnc.ddc0sucl30
                    section.data(1).logicalSrcIdx = 0;
                    section.data(1).dtTransOffset = 0;

                    ;% ntrh2fpvwnc.alab4gzm4c
                    ...
                    section.data(4).dtTransOffset = 19202;

                    ;% ntrh2fpvwnc.frziy1sz4w
                    section.data(5).logicalSrcIdx = 4;
                    section.data(5).dtTransOffset = 38402;
            ...
            section.data(5)  = dumData; %prealloc
                    ...
                    ;% ntrh2fpvwnc.iitm2i0usl
                    section.data(3).logicalSrcIdx = 7;
                    section.data(3).dtTransOffset = 2;

                    ;% ntrh2fpvwnc.k44i1ncule
                    section.data(4).logicalSrcIdx = 8;
                    section.data(4).dtTransOffset = 2147;

                    ;% ntrh2fpvwnc.fgandqzsj5
                    section.data(5).logicalSrcIdx = 9;
            ...
            section.data(9)  = dumData; %prealloc
                    ...
                    ;% ntrh2fpvwnc.fxgka2mnesn.co5cvautdu
                    section.data(2).logicalSrcIdx = 11;
                    section.data(2).dtTransOffset = 1;

                    ;% ntrh2fpvwnc.fxgka2mnesn.dfnj2ka3a1
                    ...
                    ;% ntrh2fpvwnc.fxgka2mnesn.cwaoqanix2
                    section.data(7).logicalSrcIdx = 17;
                    section.data(7).dtTransOffset = 10;

                    ;% ntrh2fpvwnc.fxgka2mnesn.e02om3vqvq
                    section.data(8).logicalSrcIdx = 18;
                    section.data(8).dtTransOffset = 11;

                    ;% ntrh2fpvwnc.fxgka2mnesn.p0h52yf1tf
                    section.data(9).logicalSrcIdx = 19;
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% ntrh2fpvwnc.fxgka2mnesn.eosxii5mtc
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(8)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.h02f5wemht
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.npc3va3ccv
                    section.data(6).logicalSrcIdx = 10;
                    section.data(6).dtTransOffset = 8;

                    ;% cjyyyt0pe2y.fxgka2mnesn.ks3foo1h1q
                    section.data(7).logicalSrcIdx = 11;
                    section.data(7).dtTransOffset = 9;

                    ;% cjyyyt0pe2y.fxgka2mnesn.aplj15p3vf
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.oapvgr0d1o
                    section.data(1).logicalSrcIdx = 44;
                    section.data(1).dtTransOffset = 0;

                    ;% cjyyyt0pe2y.fxgka2mnesn.gdkfsncbov
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.nzg21pwxmn
                    section.data(1).logicalSrcIdx = 46;
                    section.data(1).dtTransOffset = 0;

                    ;% cjyyyt0pe2y.fxgka2mnesn.ks1ime0elc
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.ic3t5emroo
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.pwpftw3vrt
                    section.data(1).logicalSrcIdx = 57;
                    section.data(1).dtTransOffset = 0;

                    ;% cjyyyt0pe2y.fxgka2mnesn.csidoj0m4m
    ...
    targMap.checksum0 = 2001316970;
    targMap.checksum1 = 3784013796;
    targMap.checksum2 = 3566900080;
    targMap.checksum3 = 3107457499;
