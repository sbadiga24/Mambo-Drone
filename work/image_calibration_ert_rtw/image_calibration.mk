###########################################################################
## Makefile generated for component 'image_calibration'. 
## 
## Makefile     : image_calibration.mk
## Generated on : Sat Apr 29 04:55:19 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/image_calibration.so
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/image_calibration.so
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022a/toolbox/target/SUPPOR~1/parrot/include -I$(START_DIR)/image_calibration_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils
...
DEFINES_STANDARD = -DMODEL=image_calibration -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = rsedu_image.o image_calibration.o image_calibration_data.o ext_svr.o updown.o ext_work.o rtiostream_utils.o rsedu_control.o rsedu_of.o rsedu_vis.o ptimer.o controlCommand.o mw_extrathreads.o rtiostream_interface.o rtiostream_tcpip.o mem_mgr.o
...
%.o : $(START_DIR)/image_calibration_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/image_calibration_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
rsedu_image.o : C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/parrot/src/rsedu_image.c
	$(CC) $(CFLAGS) -o "$@" "$<"


image_calibration.o : $(START_DIR)/image_calibration_ert_rtw/image_calibration.c
	$(CC) $(CFLAGS) -o "$@" "$<"


image_calibration_data.o : $(START_DIR)/image_calibration_ert_rtw/image_calibration_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
